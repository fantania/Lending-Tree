...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Edit Bank Form</h2>
		<spring:url value="/bank/updateBank" var="saveURL" />
		
		<form:form modelAttribute="bankEdit" method="POST"
			...
			<div class="form-group">
				<label>Branch</label>
				<form:input path="bankBranch" cssClass="form-control" id="bankBranch" />
			</div>
			
			<div class="form-group">
				<label>Address</label>
				<form:input path="bankAddress" cssClass="form-control" id="bankAddress" />
			</div>
