...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Login Failed</h2>
			<div class="row">
			<div class="shop-wrap">
		<p style="color: red;">Login or password Incorrect please try again!!!!!</p>
		<spring:url value="/login" var="addURL" />
		<a class="btn btn-success" href="${addURL}" role="button">Go Back to Login Page</a>
	</div>
