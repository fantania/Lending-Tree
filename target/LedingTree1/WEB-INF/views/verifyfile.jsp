...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
			<h2 style="color: #ff7733;">Verify Files</h2>
			<div class="row">
				<div class="shop-wrap">


					
					<spring:url value="/verifyfiles" var="saveURL" />
					<form:form method="post" action="${saveURL}">
						...
						<!-- <input type="radio" name="verify" value="verified"> Verified<br>
						<input type="radio" name="verify" value="notClear"> Not Clear<br> -->
