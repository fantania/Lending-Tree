...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Banks List</h2>
			<div class="row">
			<div class="shop-wrap">
			...
			<tbody>
				...
				<c:forEach items="${bankList}" var="bank">
					<tr>
						...
						<td><spring:url value="/bank/edit/${bank.bankId}"
								var="updateURL" /><a class="btn btn-primary"
							href="${updateURL}" role="button">Update</a></td>
						<td><spring:url value="/bank/deleteBank/${bank.bankId}"
		...
		<spring:url value="/bank/addBank/${bank.bankId}" var="addURL" />
