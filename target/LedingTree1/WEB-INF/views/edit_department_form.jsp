...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Edit Department Form</h2>
		<spring:url value="/department/updateDepartment" var="saveURL" />
		
		<form:form modelAttribute="departmentEdit" method="POST"
			action="${saveURL}" cssClass="form">

			<form:hidden path="depId" />
			<div class="form-group">
				<label>Name</label>
				<form:input path="depName" cssClass="form-control" id="depName" />
			</div>
