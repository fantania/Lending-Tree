							...
							<tbody>
								<c:forEach items="${loanList}" var="loan">
									<tr>
										...
										<td>${loan.status}</td>
										<td>${loan.loanDate}</td>
										<td><spring:url value="/loanRequest/loanAssign/${loan.loanId}"
												var="assignURL" />
												
											<div id="assignBtn"style=" background-color: #ff7733;  border-radius: 5px; width: 70px; height: 30px; text-align:center; color: #FFF"><a href="${assignURL}" role="button">Assign</a></div>
										</td>
									</tr>
								</c:forEach>
								<tr>
