...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
			<h2 style="color: #ff7733;">Legal Verification</h2>
			<div class="row">
				<div class="shop-wrap">


					
					<spring:url value="/legalfiles" var="saveURL" />
					<form:form method="post" action="${saveURL}">

							<p  style="color: green;">List of documents to verify:</p>
						

						<c:forEach items="${listDocs}" var="list">
							<ul>
								<li><b>${list.documentName}</b></li>
							</ul>
						</c:forEach>
						<br/>
						
						</table><br>
						<!-- <input type="radio" name="legalverify" value="approved"> Approved<br>
						<input type="radio" name="legalverify" value="notApproved"> Not Approved<br> -->
