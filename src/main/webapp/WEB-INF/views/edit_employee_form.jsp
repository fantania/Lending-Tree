...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Edit Employee Form</h2>
		<spring:url value="/employee/updateEmployee" var="saveURL" />
		
		<form:form modelAttribute="employeeEdit" method="POST"
			action="${saveURL}" cssClass="form">

			<form:hidden path="empId" />
			<div class="form-group">
				<label>Name</label>
				<form:input path="empName" cssClass="form-control" id="empName" />
			</div>

			<div class="form-group">
				<label>Department</label>
				<form:select path="empDep" id="empDep">
					<form:option value="NONE"> --SELECT--</form:option>
					<form:options items="${dptNames}"></form:options>
				</form:select>
			</div>
			<div class="form-group">
				<label>Phone</label>
			...
			<div class="form-group">
				<label>Address</label>
				<form:input path="empAddress" cssClass="form-control" id="empAddress" />
			</div>
