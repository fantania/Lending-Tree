...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Employees List</h2>
			<div class="row">
			<div class="shop-wrap">
			...
			<tbody>
				...
				<c:forEach items="${employeeList}" var="employee">
					<tr>
						...
						<td>${employee.empIdentifier}</td>
						<td>${employee.empPswd}</td>
						<td>${employee.empDep}</td>
						<td>${employee.empPhone}</td>
						<td>${employee.empEmail}</td>
						<td>${employee.empAddress}</td>
						<td><spring:url value="/employee/edit/${employee.empId}"
								var="updateURL" /><a class="btn btn-primary"
							href="${updateURL}" role="button">Update</a></td>
						<td><spring:url value="/employee/deleteEmployee/${employee.empId}"
		...
		<spring:url value="/employee/addEmployee/${employee.empId}" var="addURL" />
