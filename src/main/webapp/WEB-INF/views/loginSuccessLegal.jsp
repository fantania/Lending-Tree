							...
							<tbody>
								<c:forEach items="${loanList}" var="loan">
									<tr>
										...
										<td>${loan.status}</td>
										<td>${loan.loanDate}</td>
										<td><spring:url value="/legalLoan/${loan.empIdLoan}/${loan.loanId}"
												var="verifyURL" />
												
											<div id="assignBtn"style=" background-color: #ff7733;  border-radius: 5px; width: 100px; height: 50px; text-align:center; color: #FFF"><a href="${verifyURL}" role="button">Legal Verification</a></div>
										</td>
									</tr>
								</c:forEach>
							</tbody>
