...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Department List</h2>
			<div class="row">
			<div class="shop-wrap">
			...
			<tbody>
				...
				<c:forEach items="${departmentList}" var="department">
					<tr>
						...
						<td><spring:url value="/department/edit/${department.depId}"
								var="updateURL" /><a class="btn btn-primary"
							href="${updateURL}" role="button">Update</a></td>
						<td><spring:url value="/department/deleteDepartment/${department.depId}"
		...
		<spring:url value="/department/addDepartment/${department.depId}" var="addURL" />
