...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
			<h2 style="color: #ff7733;">Upload Files</h2>
			<div class="row">
				<div class="shop-wrap">



					<spring:url value="/savefiles" var="saveURL" />
					<form:form method="post" action="${saveURL}"
						modelAttribute="uploadForm" enctype="multipart/form-data">

						<p>Select files to upload. Press Add button to add more file
							inputs.</p>
						<p style="color: green;">Following the list of documents to
							upload:</p>
						...
						<!-- <input type="radio" name="upload" value="uploaded"> All Documents<br>
						<input type="radio" name="upload" value="notUploaded"> Missing Documents<br> -->
