			...
			<div class="row">
				<div class="col-lg-7 col-12">
					<div class="nvestments-wrap">
						<%-- <h2>
							Congratulations dear <span> ${name} </span> <br> Your loan
							request application has been submited successfully !!!
						</h2>
						<p>One of our team member will contact you shortly for pick up
							documents</p> --%>
						<div style="background-color: #ff7733;border-radius: 30px; width: 500px; height: 130px; text-align:center;">
							<%-- <p>Other Information below for futher enquiry</p>
						...
						<ul>
							<!-- <li><a href="/LedingTree1/login">LOGIN</a></li> -->
							<li><a href="http://localhost:8181/LedingTree1/loanRequest/loanRequestList">GO BACK</a></li>
							<li><a href="http://localhost:8181/LedingTree1/login">LOGOUT</a></li>
				...
				<div class="col-lg-5 d-none d-lg-block">
					<div class="nvestments-img">
						<img src="<c:url value="/resources/images/bg/1.png" />">
					</div>
				</div>
			</div>
		</div>
