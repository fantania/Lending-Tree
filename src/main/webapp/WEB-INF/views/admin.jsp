...
fa-angle-down"></i></a>
	...
	<div class="shop-area">
		...
		<div class="container">
		<h2 style="color: #ff7733;">Admin Page</h2>
			<div class="row">
			<div class="shop-wrap">
				
			<spring:url value="/bank/list"
								var="bank" /><a class="btn btn-primary" href="${bank}"
							role="button">BANK</a>
							
			<spring:url value="/department/list"
								var="dep" /><a class="btn btn-primary" href="${dep}"
							role="button">DEPARTMENT</a>
			<spring:url value="/employee/list"
								var="emp" /><a class="btn btn-primary" href="${emp}"
							role="button">EMPLOYEE</a>
			<spring:url value="/customer/list"
								var="cust" /><a class="btn btn-primary" href="${cust}"
							role="button">CUSTOMER</a>
			<spring:url value="/loanRequest/loanRequestList"
								var="loan" /><a class="btn btn-primary" href="${loan}"
							role="button">LOANS</a>
			</div>

			<div><spring:url value="/login"
